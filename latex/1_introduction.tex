...
\begin{itemize}
    ...
    \item \textbf{RQ2: How do different positional encoding schemes affect the model's ability to perform addition correctly on longer sequences?}
          
          By experimenting with various positional encodings, including absolute, relative, randomized, and specialized encodings like Abacus, this work aims to evaluate their impact on length generalization and identify the characteristics that contribute to improved performance.
          
    \item \textbf{RQ3: How does the inclusion of sub-task data (carry detection, digit-wise modular addition, reversing, digit alignment) influence the model's compositionality and length generalization capabilities?}
    ...
    \item \textbf{RQ4: How can mechanistic interpretability techniques be applied to understand the internal representations and failure modes of transformer models in the context of integer addition?}
