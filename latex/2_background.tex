...
This phenomenon is particularly relevant in integer addition tasks, where by studying how double descent phenomenon emerges with respect to different sequence lengths and model dimensions can shed light on the interpolation threshold — the point where the model transitions from memorization to generalization.
