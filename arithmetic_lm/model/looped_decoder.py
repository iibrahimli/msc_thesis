...
class LoopedDecoder(nn.Module):
    """Looped transformer decoder model"""
    ...
    def __init__(
        ...
        Arguments:
            ...
            n_layers: number of layers in a block
            ...
            input_injection: whether to add original input seq to each block's input
        """
    ...
    def forward(self, x: Tensor, n_loops: int | None = None) -> Tensor:
        """
        Arguments:
            x: Tensor, shape ``[batch_size, seq_len]``
            n_loops: number of recurrent application of the block. None =
                # of tokens in the sequence / 2
